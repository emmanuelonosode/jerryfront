...
export function LeaseAgreementDocument({
  ...
  tenantName = 'Resident',
  tenantAddress = '745 Academy Ln, Deer Park, TX 77536',
  tenantEmail = 'resident@example.com',
  propertyType = 'house',
  bedrooms = 'three (3)',
  bathrooms = 'two (2)',
  parkingSpaces = 'two (2)',
  propertyAddress = '745 Academy Ln, Deer Park, TX 77536',
  termStartDate = '6th of September, 2024',
  termEndDate = '31st of August, 2025',
  annualRent = '$19,152.00',
  monthlyRent = '$1,596.00',
  rentDueDay = '5th',
  securityDeposit = '$1,596.00',
